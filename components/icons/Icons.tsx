...
export const SwazLogoIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor" {...props}>
        <path d="M50,90 L20,60 C10,50 10,20 40,10 L50,30 L60,10 C90,20 90,50 80,60 L50,90 Z" />
    </svg>
);
...
export const SsdIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H4.5a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 1 0 12 10.125A2.625 2.625 0 0 0 12 4.875Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.875c-1.448 0-2.625 1.177-2.625 2.625s1.177 2.625 2.625 2.625 2.625-1.177 2.625-2.625S13.448 4.875 12 4.875Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 11.25h16.5" />
    </svg>
);
...
export const UsbIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V18m0-15H6.375c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h11.25c.621 0 1.125-.504 1.125-1.125V4.125c0-.621-.504-1.125-1.125-1.125H15.75m-7.5 0v-1.5m7.5 0v-1.5m0 15v1.5m-7.5 0v1.5" />
    </svg>
);

export const RaidIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-2.122c.235.083.487.128.75.128A2.25 2.25 0 0 1 21 9v.878m-13.5 0A2.25 2.25 0 0 0 4.5 12v.878m13.5-2.122c.235.083.487.128.75.128A2.25 2.25 0 0 1 21 12v.878m-13.5 0A2.25 2.25 0 0 0 4.5 15v.878m13.5-2.122c.235.083.487.128.75.128A2.25 2.25 0 0 1 21 15v.878m0 0A2.25 2.25 0 0 1 18.75 18h-13.5A2.25 2.25 0 0 1 3 15.878v0" />
    </svg>
);
...
export const QuoteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" {...props}>
        <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388q0-.527.062-1.054.093-.558.31-.992t.558-.67.968-.314q.844 0 1.39.625.647.625.647 1.848v.313a1 1 0 0 0 1 1h.5a1 1 0 0 0 1-1V8.558q0-1.828-1.2-3.052T12.553 4.23q-1.426 0-2.426 1.025T9 8.138v2.812a1 1 0 0 0 1 1zM4 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H2.612q0-.527.062-1.054.094-.558.31-.992t.559-.67.968-.314q.844 0 1.39.625.647.625.647 1.848v.313a1 1 0 0 0 1 1h.5a1 1 0 0 0 1-1V8.558q0-1.828-1.2-3.052T4.553 4.23q-1.426 0-2.426 1.025T1 8.138v2.812a1 1 0 0 0 1 1z" />
    </svg>
);
...
export const CopyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.332 0c-.055-.194-.084-.4-.084-.612v-3.042m0 0a2.25 2.25 0 0 0-2.25-2.25h-3a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 4.5 21h3a2.25 2.25 0 0 0 2.25-2.25V15.75m9-13.5h-3a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 10.5 21h3a2.25 2.25 0 0 0 2.25-2.25V15.75m-9 0h9" />
    </svg>
);
